...
## Project Overview
The App Accelerator (internal codename: Seed) is an AI-powered full-stack application generation platform. Customer-facing brand is "The App Accelerator"; the conversational agent persona is "Appy"; internal identifiers, env vars, and resource names use "seed".
