				...
				<div className="relative">
					...
					<div className="relative z-10 grid grid-cols-[auto_1fr_auto] items-center gap-4 px-5 py-2">
						...
						{user ? (
							...
							>
								<SidebarTrigger className="h-8 w-8 text-text-primary rounded-md hover:bg-brand-subtle/15 transition-colors duration-200" />
								<div className="flex items-center gap-2 ml-2">
									...
									/>
									<span className="text-sm font-semibold tracking-tight text-text-primary hidden sm:inline">The App Accelerator</span>
								</div>
