...
- Best compatibility - This is the recommended model for production deployments
...
- KV Namespace for `SeedStore`
- D1 Database named `seed-db`
- R2 Bucket named `seed-templates`
...
- Local-only development isn't yet supported for this in The App Accelerator
