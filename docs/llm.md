# LLM Developer Guide for The App Accelerator (Seed)

> **Meta-Instruction for AI Assistants:**
>
> This document contains comprehensive architectural knowledge for **The App Accelerator** (internal codename: **Seed**) - an AI-powered full-stack app generation platform.
>
...
- Defines Appy personality, tool usage rules, behavior
...
│   │   │   ├── UserConversationProcessor.ts  # Appy (42k lines)
...
The platform uses **isomorphic-git** to manage version control entirely in the browser/Worker environment - no git binary required.
...
**Usage:**
```bash
git clone https://seed.ar/git/{agentId}
```
...
## 🤖 Conversational AI System ("Appy")

### **Purpose**
Appy is the AI interface between users and the development agent. It handles:
...
**CRITICAL:** Appy speaks AS IF it's the developer:
...
4. Tool is now available to conversation agent (Appy)
...
**SimpleCodeGeneratorAgent** is the brain of the platform - a Durable Object that orchestrates the entire app generation lifecycle.
...
- `/worker/agents/operations/UserConversationProcessor.ts` - Appy (818 lines)
