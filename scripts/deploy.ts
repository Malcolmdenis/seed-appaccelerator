...
class CloudflareDeploymentManager {
	...
	private createProdVarsFile(): void {
		...
		const prodVarsContent: string[] = [
			'# Production environment variables for Seed',
	...
	public async deploy(): Promise<void> {
		console.log(
			'Seed - Automated Deployment Starting...\n',
		);
		...
		try {
			...
			if (deploymentSucceeded) {
				...
				console.log(
					`The App Accelerator is now live at https://${customDomain}`,
				);
