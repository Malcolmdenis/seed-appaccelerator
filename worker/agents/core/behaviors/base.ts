        ...
        try {
            ...
            if (!this.state.sandboxInstanceId) {
                ...
                if (!this.state.sandboxInstanceId) {
                    ...
                    this.broadcast(WebSocketMessageResponses.PRODUCTION_DEPLOYMENT_ERROR, {
            ...
            const result = await this.deploymentManager.deployToCloudflare({
                ...
                callbacks: {
                    onStarted: (data) => {
                        this.broadcast(WebSocketMessageResponses.PRODUCTION_DEPLOYMENT_STARTED, data);
                    },
                    onCompleted: (data) => {
                        this.broadcast(WebSocketMessageResponses.PRODUCTION_DEPLOYMENT_COMPLETED, data);
                    },
                    onError: (data) => {
                        this.broadcast(WebSocketMessageResponses.PRODUCTION_DEPLOYMENT_ERROR, data);
                    },
                }
            });
            ...
            this.logger.error('Production deployment error:', error);
            this.broadcast(WebSocketMessageResponses.PRODUCTION_DEPLOYMENT_ERROR, {
