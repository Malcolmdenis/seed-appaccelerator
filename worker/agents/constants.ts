...
export const WebSocketMessageResponses: Record<string, WebSocketMessageType> = {
    ...
    // Production deployment messages
    PRODUCTION_DEPLOYMENT_STARTED: 'production_deployment_started',
    PRODUCTION_DEPLOYMENT_COMPLETED: 'production_deployment_completed',
    PRODUCTION_DEPLOYMENT_ERROR: 'production_deployment_error',
